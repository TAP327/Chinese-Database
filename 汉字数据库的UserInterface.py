...
class Ui:
    ...
    def _createUiWindow(self) -> None:
        ...
        练习的题目 = Frame(练习的框架, height=50, width=600, bg="pale turquoise")
        练习的题目.place(x=0, y=0)
        Label(练习的题目, text="咱们练习中文吧! ", width=20, font=15, bg="pale turquoise").place(
            x=10, y=10
        )

        # Create Study Refiner
        study_refiner = Frame(练习的框架, height=350, width=135, bg="light cyan", padx=2)
        study_refiner.place(x=0, y=50)

        # Add Study Refining Labels
        char_label = Label(study_refiner, text="Character: ", bg="light cyan")
        pinyin_label = Label(study_refiner, text="Pin1Yin1: ", bg="light cyan")
        pos_label = Label(study_refiner, text="Part of Speech: ", bg="light cyan")
        eng_label = Label(study_refiner, text="English: ", bg="light cyan")
        choose_lang_label = Label(study_refiner, text="设定: ", bg="light cyan")
        ...
        中文字 = Label(study_refiner, text="En", bg="light cyan")
        英文字 = Label(
            study_refiner,
            text="Zh",
            bg="light cyan",
        ...
        英文的设定 = Radiobutton(study_refiner, bg="light cyan")
        ...
        # Add Study Button
        练习的按键 = Button(study_refiner, text="练习", bg="azure")
        练习的按键.place(x=50, y=275)

        # Create Study Frame
        study_frame = Frame(练习的框架, height=350, width=450, padx=2, bg="azure")
        ...
        pinyin_answer_label = Label(study_frame, text="Pin1yin1:  ", bg="azure")
        pinyin_answer_label.place(x=80, y=80)

        translation_answer_label = Label(study_frame, text="Translation:  ", bg="azure")
        ...
        pinyin_answer = Label(
            study_frame,
            textvariable=self._valueDict["pin1yin1Response"].get(),
            bg="azure",
        )
        pinyin_answer.place(x=180, y=113)
        translation_answer = Label(
            study_frame,
            textvariable=self._valueDict["translationResponse"].get(),
            bg="azure",
        )
        ...
        correct_check = Checkbutton(study_frame, bg="azure")
        ...
        percent_complete = Label(
            study_frame, textvariable=[percent + "% Complete"], bg="azure"
        )
